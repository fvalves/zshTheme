...
syn keyword vbnetBuiltinType    Boolean Byte Char Date Decimal Double Single Integer Long Object Short String Trans T Position P Joint J Vector V S skipwhite nextgroup=vbnetGeneric
...
syn keyword vbnetRobotic Tool ChangeTool Work ChangeWork TakeArm Keep Delay MotionSkip TMul TInv LetX LetY LetZ LetP LetRx LetRy LetRz Fig ForceParam ForceSensor ForceCtrl SysLog PosX PosY PosZ PosRx PosRy PosRz PVec RVec Move PrintDbg P2T P2J T2P T2J J2P J2T CurPos Halt
...
if ! exists("vbnet_no_functions")
    ...
    syn keyword vbnetMSVBMath Randomize Rnd Abs Sin Cos Acos Asin Atn Atn2 Sgn
...
if version >= 508 || !exists("did_vbnet_syntax_inits")
    ...
    HiLink vbnetRobotic                 vbnetMSFunction
